  ...
  return (
    <div className="flex h-screen items-center justify-center bg-white">
      <div className="w-full max-w-md px-8">
        <h1 className="text-2xl font-bold text-center mb-1">截屏解题助手</h1>
        <p className="text-sm text-gray-500 text-center mb-8">选择本次运行模式</p>
          ...
          <div>
            ...
            {showRemoteForm && (
              <div className="mt-3 rounded-lg border border-gray-200 p-4 space-y-3">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1">服务端 URL</label>
                  <input
                    type="text"
                    value={inputUrl}
